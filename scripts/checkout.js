...
import {hello} from 'https://unpkg.com/supersimpledev@1.0.1/hello.esm.js'; // импорты библиотек
...
//const today = dayjs();
//const deliveryDate = today.add(7, 'days'); // добавляет 7 дней к твоему времени
...
function deliveryOptionsHTML(mathingProduct, cartItem){
    let html = '';
    ...
    === 0 // если цена = 0 то писать 'FREE' а остальное delivery.priceCents тоесть цена из списка словарей
        ? 'FREE'
